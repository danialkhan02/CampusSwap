...
def handle_update_user(user_id: str, updated_user: UpdateUser):
    ...
    Only allows updating profile_image_url, phone_number, and description fields.
    
    Args:
        user_id: The UUID of the user to update
        updated_user: User object containing the updated information
        
    Returns:
        The updated user object if successful, None if user not found
    """
