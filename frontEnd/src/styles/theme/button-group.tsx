  ...
  base: [
    {
      ...
      style: ({ theme }) => ({
        [buttonClasses]: {
          borderRight: `solid 1px ${alpha(theme.palette.grey[500], 0.32)}`,
...
const MuiButtonGroup: Components<Theme>['MuiButtonGroup'] = {
  ...
  styleOverrides: {
    ...
    contained: ({ theme, ownerState }) => {
      const styled = {
        colors: styleColors(ownerState, (color) => ({
          [buttonClasses]: { borderColor: alpha(theme.palette[color].dark, 0.48) },
        })),
        inheritColor: {
          ...(ownerState.color === 'inherit' && {
            [buttonClasses]: { borderColor: alpha(theme.palette.grey[500], 0.32) },
          }),
        },
        disabled: {
          ...(ownerState.disabled && {
    ...
    text: ({ theme, ownerState }) => {
      const styled = {
        colors: styleColors(ownerState, (color) => ({
          [buttonClasses]: { borderColor: alpha(theme.palette[color].main, 0.48) },
        })),
        inheritColor: {
          ...(ownerState.color === 'inherit' && {
            [buttonClasses]: { borderColor: alpha(theme.palette.grey[500], 0.32) },
